...
## Changes  
v2.3.1  
- Less crashes when metadata parsing gives an error.  
- Report for the images with metadata issues.  
- `difbrow.bat` added. Double click to open Diffusion Browser on Windows.  
